...
<?php
	...
	$query="SELECT Recipe.rid as rid, rtitle, rServNum,rCookTime, rSteps, round(avg(rate),2) as avgrate FROM Recipe join Review on Recipe.rid = Review.rid group by Recipe.rid having avgrate >4";
// 	echo $query;
